//setup stuff 
  ...
  //setup stuff for sensors
    ...
    int Pulse=1100; //this is for the arming stuff
...
void setup() 
  {
  //so we can see output on the consol
  ...
  //get max values for accelerometer --dont know how this works
    sensor_t sensor;
...
void loop() 
  {
    ...
    //read accelerometer stuff --NEEDS TO BE CHECKED
      readAccel();                  //sets x,y,z-raw;
      now = millis();               //gets the time the loop has been running in milliseoconds
      Serial.println("Scaling");    //why is this here?
    ...
    //read gyroscope stuff --NEEDS TO BE CHECKED
